...
_activeControl = uiNamespace getVariable ["OT_INV_active_button_control", controlNull];
...
// find selected item
['selectItem',_main_control,_idc] call DEDF_fnc_armorCalc;
...
if !(_interactedItem isEqualTo []) then {
    ...
    if !(_interactActions isEqualTo []) then {
        ...
        uiNamespace setVariable ["OT_INV_active_button_control", _control];
        ...
        _start_idc = 12346;
        {
            ...
            switch (_btn_mode) do {
                case 1: {
                    ...
                    _button_gen ctrlAddEventHandler ["ButtonClick","(uiNamespace getVariable ['OT_INV_active_button_control', controlNull]) ctrlShow false;"];
                    _y2d = _y2d + 0.0625;
        ...
        reverse _btn_arr;
        uiNamespace setVariable ["OT_INV_active_controls", ([_control,_bg,_buffer] + _btn_arr) ];
        {ctrlSetFocus _x} forEach (uiNamespace getVariable ["OT_INV_active_controls", []]);
    };
};
