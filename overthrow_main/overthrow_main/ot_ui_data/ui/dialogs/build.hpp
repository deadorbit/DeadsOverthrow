...
class OT_dialog_buildtown
{
	...
	class controls
	{
		...
		{
			idc = 1601;
			action = "'Jammer' call build";

			text = "Drone Jammer"; //--- ToDo: Localize;
			x = 0.0204687 * safezoneW + safezoneX;
			y = 0.764 * safezoneH + safezoneY;
			w = 0.0876563 * safezoneW;
			h = 0.077 * safezoneH;
			tooltip = "Destroys Recon Drones"; //--- ToDo: Localize;
		};
		////////////////////////////////////////////////////////
		// GUI EDITOR OUTPUT END
		////////////////////////////////////////////////////////
...
class OT_dialog_police
{
	...
	class controlsBackground
	{
		class RscStructuredText_1100: RscOverthrowStructuredText
		{
			...
			text = "<t size=""2"" align=""center"">Blah Blah Police Station</t>"; //--- ToDo: Localize;
	...
	class controls
	{
		...
		class RscStructuredText_1103: RscOverthrowStructuredText
		{
			...
			colorBackground[] = {0,0,0,0};
			colorActive[] = {0,0,0,0};
			tooltip = "Opening this menu will 'sell' all police, requiring them to be rebought at each town. There equipment will be returned.";
		};
