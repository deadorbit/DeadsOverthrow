...
//Thematic defines
#define OT_THEME_MENU_BACKGROUND {0.118,0.114,0.141,0.902}
#define OT_THEME_MENU_IMAGE_BACKGROUND {1,1,1,0.25}

#define OT_THEME_MENU_TEXT {0.776,0.792,0.808,1}
#define OT_THEME_MENU_TEXT_HEX "#C6C9CE"

#define OT_THEME_MENU_TEXT_SECONDARY {0.582,0.594,0.606,1}
#define OT_THEME_MENU_TEXT_SECONDARY_HEX "#94979B"

#define OT_THEME_MENU_FONT "OxaniumRegular"
#define OT_THEME_MENU_FONT_BOLD "OxaniumBold"

//General useful
#define safezoneWX safezoneW + safezoneX
#define safezoneHY safezoneH + safezoneY
...
#include "macros\imagewithbackground_macro.hpp"
...
class RscOverthrowControlsGroupNoScrollbars : RscControlsGroupNoScrollbars{};
...
class RscOverthrowActivePicture : RscOverthrowActiveText{
	style = ST_MULTI + ST_TITLE_BAR;
	color[] = {1,1,1,0.5};
	colorActive[] = {1,1,1,1};
};

class RscOverthrowActivePictureKeepAspect : RscOverthrowActivePicture {
	style = ST_MULTI + ST_TITLE_BAR + ST_KEEP_ASPECT_RATIO;
};

class RscOverthrowStaticBox {
	deletable = 0;
	fade = 0;
	type = CT_STATIC;
	idc = -1;
...
class RscOverthrowPictureKeepAspect : RscOverthrowPicture {
...
//Button that doesnt do any effect when hovered over?
class overthrowCT_XButton {
	idc = -1;
	type = CT_XBUTTON;
	style = 0;
	default = 0;
...
class RscOverthrowMapControlEmpty : RscMapControlEmpty{};