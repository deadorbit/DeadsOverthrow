...
class OT_dialog_place
{
	...
	class controls
	{
		...
		class RscButton_1600: RscOverthrowButton
		{
			...
			h = 0.088 * safezoneH;
			tooltip = "Light defenses, effectiveness proven throughout centuries"; //--- ToDo: Localize;
		};
		class RscButton_1601: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "Hide from helicopters, or the sun"; //--- ToDo: Localize;
		};
		class RscButton_1602: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "Medium defenses that may look slightly suspicious"; //--- ToDo: Localize;
		};
		class RscButton_1603: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "Creates a temporary fast travel destination"; //--- ToDo: Localize;
		};
		class RscButton_1604: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "An empty ammobox, definitly not suspiscious"; //--- ToDo: Localize;
		};
		...
		class RscButton_1606: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "Creates a fast travel destination, allows building useful guerilla structures. May attract NATO if found."; //--- ToDo: Localize;
		};
		class RscButton_1607: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "A map, no one uses these any more."; //--- ToDo: Localize;
		};
		class RscButton_1608: RscOverthrowButton
		{
			...
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "Stores money safely, can be locked from other players."; //--- ToDo: Localize;
		};
		class RscButton_1609: RscOverthrowButton
		{
			idc = 1609;
			action = "closeDialog 0;'Furniture' spawn OT_fnc_place";

			text = "Furniture"; //--- ToDo: Localize;
			x = 0.463594 * safezoneW + safezoneX;
			y = 0.797 * safezoneH + safezoneY;
			w = 0.0928125 * safezoneW;
			h = 0.088 * safezoneH;
			tooltip = "Random decorative junk to slow down your game!"; //--- ToDo: Localize;
		};
		////////////////////////////////////////////////////////
		// GUI EDITOR OUTPUT END
		////////////////////////////////////////////////////////
