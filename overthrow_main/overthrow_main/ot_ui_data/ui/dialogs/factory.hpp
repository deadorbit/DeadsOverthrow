...
class OT_dialog_factory
{
	...
	class controls
	{
		...
		class RscButton_1609: RscOverthrowButton
		{
			...
			w = 0.128906 * safezoneW;
			h = 0.066 * safezoneH;
			tooltip = "Upgrade the factory to reduce the time it takes to construct items by 25% each level.";
			action = "closeDialog 0;[] call OT_fnc_factoryUpgradeDialog;";
		};
...
class OT_dialog_craft
{
	...
	class controlsBackground {
		...
		{
			idc = 1199;
			x = 0.177735 * safezoneW + safezoneX;//Moved by 0.069609
			y = 0.214 * safezoneH + safezoneY;
	...
	class controls
	{
		...
		{
			idc = 1500;
			x = 0.177735 * safezoneW + safezoneX;
			y = 0.225 * safezoneH + safezoneY;
			w = 0.402187 * safezoneW;
			h = 0.55 * safezoneH;
			colorBackground[] = {0,0,0,0.9};
		...
		class RscPicture_1200: RscOverthrowPicture
		{
			idc = 1200;
			text = "";
			x = 0.585079 * safezoneW + safezoneX;
			y = 0.225 * safezoneH + safezoneY;
		...
		class RscButton_1600: RscOverthrowButton
		{
			...
			x = 0.683047 * safezoneW + safezoneX;
		...
		class RscStructuredText_1101: RscOverthrowStructuredText//Top label, displays shop name
		{
			...
			h = 0.044 * safezoneH;
			colorBackground[] = {0,0,0,0.8};
			text = "<t size='1.7' shadow='2' align='left' valign = 'middle'>Crafting</t>";
		};
		class RscButton_1699: RscOverthrowButton//Close dialog buttton
        {
            ...
            text = "X"; //--- ToDo: Localize;
			action = "closeDialog 0";
            x = 0.8016408 * safezoneW + safezoneX;
            y = 0.17 * safezoneH + safezoneY;
            w = 0.0257812 * safezoneW;
            h = 0.044 * safezoneH;
...
class OT_dialog_FacUpgrade
{
	...
	class controls
	{
		...
		{
			idc = -21;
			action = "closeDialog 0;[] spawn OT_fnc_factoryUpgrade;";
