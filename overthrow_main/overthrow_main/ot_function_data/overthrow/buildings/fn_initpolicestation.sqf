...
private _post = (_pos nearObjects [OT_policeStation,10]) select 0;
...
private _Buildings = missionnamespace getVariable [format['policebuild%1',_town],[]];
_Buildings pushBack _post;
missionnamespace setVariable [format['policebuild%1',_town],_Buildings,true];
