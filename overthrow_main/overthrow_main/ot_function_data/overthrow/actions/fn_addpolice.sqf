...
if ((_garrison + _amt) > 10) exitWith {"This would put you over the police limit" call OT_fnc_notifyMinor};
...
((findDisplay 9000) displayCtrl 1101) ctrlSetStructuredText parseText format["<t size=""1.5"" align=""center"">Police: %1/10</t>",_garrison];
