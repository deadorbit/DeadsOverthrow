...
income_system_lasthour = systemtime select 3;//Real world hour

["income_system_loop","_counter%3 isEqualTo 0 && {!(income_system_lasthour isEqualTo (systemtime select 3))}","
income_system_lasthour = systemtime select 3;
...
if(true) then {
...

	{
		...
		_lease = 0;
		{
			...
			private _data = [_cls,_town,_pos] call OT_fnc_getRealEstateData;
