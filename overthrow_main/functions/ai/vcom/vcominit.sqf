...
if (isServer) then
{
	...
	{
		private _Filecheck = loadFile "overthrow_main\functions\AI\Vcom\userconfig\VCOM_AI\AISettingsV3.hpp";

		if !(_FileCheck isEqualTo "") then
		{
			[] call compile preprocessFileLineNumbers "overthrow_main\functions\AI\Vcom\userconfig\VCOM_AI\AISettingsV3.hpp";
