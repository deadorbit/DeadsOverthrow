...
//[] spawn OT_fnc_advancedTowingInit; -Added in ace
//AI Driving Control (script version)
//null = execVM "\overthrow_main\functions\aidrivingcontrol\init.sqf";
//Note: causes immenense amount of lag on server
