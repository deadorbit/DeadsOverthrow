if (!(isNil "zbe_allGroups")) exitWith {};
...
zbe_ObjCache				= false;
if ((count _this) > 6) then {zbe_ObjCache	= _this select 6};

zbe_ObjCacheLite			= false;
if ((count _this) > 7) then {zbe_ObjCacheLite	= _this select 7};

zbe_NoHideMode				= false;
if ((count _this) > 8) then {zbe_NoHideMode	= _this select 8};
...
call compileFinal preprocessFileLineNumbers "overthrow_nr6_hal\zbe_cache\zbe_functions.sqf";
...
//			if ((waypointType [_x,currentWaypoint _x]) == "GETIN") then {_disable = true};
			if (!(_disable) && !(_x in zbe_cachedGroups)) then {
				 ...
				 [zbe_aiCacheDist, _x, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_aiCaching.fsm";
				};
			if ((_disable) && (_x in zbe_cachedGroups)) then {
					zbe_cachedGroups = zbe_cachedGroups - [_x];
				};
			...
			_assetscar = zbe_centerPOS nearEntities ["LandVehicle", zbe_mapside];
			{
				if !(_x in zbe_cached_cars) then {
					zbe_cached_cars = zbe_cached_cars + [_x];
						[_x, zbe_vehicleCacheDistCar] execFSM "overthrow_nr6_hal\zbe_cache\zbe_vehicleCaching.fsm";
				};
			} forEach _assetscar;
			_assetsair = zbe_centerPOS nearEntities ["Air", zbe_mapside];
			{
				if !(_x in zbe_cached_air) then {
					zbe_cached_air = zbe_cached_air + [_x];
						[_x, zbe_vehicleCacheDistAir] execFSM "overthrow_nr6_hal\zbe_cache\zbe_vehicleCaching.fsm";
				};
			} forEach _assetsair;
			_assetsboat = zbe_centerPOS nearEntities ["Ship", zbe_mapside];
			{
				if !(_x in zbe_cached_boat) then {
					zbe_cached_boat = zbe_cached_boat + [_x];
						[_x, zbe_vehicleCacheDistBoat] execFSM "overthrow_nr6_hal\zbe_cache\zbe_vehicleCaching.fsm";
				};
			} forEach _assetsboat;
...
// if (!isDedicated) then {execFSM "overthrow_nr6_hal\zbe_cache\zbe_clientObjectDrawAuto.fsm";};
...
if ((count zbe_cachedEnt) > 30) then {
	...
	[zbe_aiCacheDist,zbe_cachedEnt1, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
	sleep 2;

if ((count zbe_cachedEnt) > 30) then {

		[zbe_aiCacheDist,zbe_cachedEnt2, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt3, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt4, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt5, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt6, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt7, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt8, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt9, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt10, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt11, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt12, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt13, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt14, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt15, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt16, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt17, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt18, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt19, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt20, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt21, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt22, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt23, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt24, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt25, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt26, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt27, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt28, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt29, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
		sleep 2;
		[zbe_aiCacheDist,zbe_cachedEnt30, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching.fsm";
...
//	zbe_cachedEnt = ((zbe_centerPOS nearObjects ["Static", 5000000]) + (nearestTerrainObjects [zbe_centerPOS, ["TREE","SMALL TREE","BUSH"], 5000000]));
	...
	{[750,_x, zbe_minFrameRate, zbe_debug] execFSM "overthrow_nr6_hal\zbe_cache\zbe_statCaching2.fsm"} forEach zbe_cachedEnt;
};
