...
OT_spawnTowns = ["Goisse","Vigny","Arette"];
OT_capitals = ["La Trinite","Le Port"]; //region capitals
OT_mainCapital = "La Trinite";
OT_sprawling = ["Arette","Le Port"];
OT_Ports = [[3554.3,3276.95,0],[7817.58,3076.95,0]];
