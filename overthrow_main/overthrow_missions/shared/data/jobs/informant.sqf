...
[
    ...
    _markerPos,
    {
        ...
        while {(_count < _numGoons)} do {
            ...
            _civ = _bgroup createUnit [(selectRandom OT_NATO_Reinforcements),_destination,[],5,"NONE"];
