...
OT_townData = [
    ...
    [[9337.174,15881.169,0],"Agios Dionysios"],
    ...
    [[10435.076,17236.395,0],"Orino"],
    [[17059.7,9992.32,0],"Ekali"],
    [[18753.4,16597.1,0],"Rodopoli"],
    [[3608.63,10281.1,0],"Athanos"],
	[[6175.82,15044.3,0],"Stadium View"],
	[[9273.38,8066.55,0],"Sfaka"],
	[[21466.1,10860,0],"Aktinarki"]
];

OT_spawnTowns = ["Poliakko","Negades","Abdera","Katalaki","Orino","Oreokastro"];
OT_capitals = ["Kavala","Athira","Pyrgos"]; //region capitals
OT_mainCapital = "Pyrgos"; //Main capital of map, always spawns with 100 stability
OT_sprawling = ["Stadium View","Agios Konstantinos","Agia Triada","Sfaka","Aktinarki"];
OT_Ports = [[3300.73,12937.7,0],[16558.4,12475.8,0]];

["Town data was loaded.", "STARTUP_SERVER"] call OT_fnc_debugLog;
