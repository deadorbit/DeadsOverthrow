...
_difficulty = selectRandom _difficulty;
...
private _aircrafts = [["Tu-95",""], ["C-130",""], ["MiG-29", ""]]; //Tag, wreck template

//Build a mission description and title
private _description = format["We'll keep it brief: A plane carrying sensitive documents. Trust us, these documents hold secrets that could crumble empires. We have intel the black ops group have %1",_difficultyDesc];
private _title = "Gravity's Rainbow: Easy";
